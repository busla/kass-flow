...
@pytest.fixture  # type: ignore
def kass_callback_response() -> KassCallbackPaymentDict:
    payload: KassCallbackPaymentDict = {
...
@pytest.fixture  # type: ignore
def kass_payload_valid() -> KassRequestPaymentDict:
...
@pytest.fixture  # type: ignore
def kass_payload_invalid_recipient() -> KassRequestPaymentDict:
    payload: KassRequestPaymentDict = {
        "amount": 2199,
        "description": "Kass bolur",
        "image_url": "https://photos.kassapi.is/kass/kass-bolur.jpg",
...
@pytest.fixture  # type: ignore
def kass_instance(get_kass_token_test: str, get_kass_url: str) -> KassBilling:
